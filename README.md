...
This tutorial includes the Nodejs code and step-by-step instructions on using Pulumi as an orchestrator to successfully make API calls to AWS and set up a DMS replication group along with all the necessary roles as well as required policy attachments without encountring IAM eventual consistency.
